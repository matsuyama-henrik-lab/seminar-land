...
くわしくは [チュートリアル 5章](../index.md#5-アイテムやタイルで組み立てる) を見てください。
...
| <img src="../images/items/gravity_flip.png" width="48"> | [重力ぎゃくてん（gravity_flip）](gravity_flip.md) | さわると重力が上下ぎゃくになる。 |
...
> 自作アイテムの作り方は [チュートリアル 6章](../index.md#6応用かんたんなアイテムを自作する) へ。
